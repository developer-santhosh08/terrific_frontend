                    ...
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center tw-gap-4">
                            <button
                                ...
                                onClick={() => navigate('/power-master/enquiry-config/transporter-mode/add')}
                            >
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/enquiry-config/transporter-mode/edit/${e.id}`)}>
