...
const EnquiryEditList = () => {
    const { hasPermission } = usePermissions();
    const hasActionPermission = hasPermission('Enquiry.Enquiry.Edit') || hasPermission('Enquiry.Enquiry.Delete') || hasPermission('Enquiry.Enquiry.Print');
    ...
    const [data, setData] = useState([
        { id: 1, transporterName: 'enquiryConfig', status: 'Active' },
        { id: 2, transporterName: 'enquiryType', status: 'Inactive' }
    ]);
    ...
    const handleConfirmDelete = async () => {
        try {
            await apiFetch(`/master/enquiry-edit-config/${pendingDeleteId}`, { method: 'DELETE' });
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title"> Enquiry Edit</h3>
                        <div className="d-flex align-items-center tw-gap-4">
                            <button
                                className="btn-create d-flex align-items-center tw-gap-1"
                                onClick={() => navigate('/power-master/enquiryconfig/enquiryedit/add')}
                            >
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/enquiryconfig/enquiryedit/edit/${e.id}`)}>
...
export default EnquiryEditList;
