...
const AreaMarketingList = () => {
    ...
    const [data, setData] = useState([
        { id: 1, staffName: 'C.RAJU', areaName: 'Chennai North', from: '2026-01-01', to: '2026-06-30', status: 'Active' },
        { id: 2, staffName: 'M.KUMAR', areaName: 'Chennai South', from: '2026-02-01', to: '2026-12-31', status: 'Active' },
    ]);
    ...
    const handleConfirmDelete = async () => {
        try {
            await apiFetch(`/master/area-marketing-person/${pendingDeleteId}`, { method: 'DELETE' });
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/hr/areamarketing/edit/${e.id}`)}>
...
export default AreaMarketingList;
