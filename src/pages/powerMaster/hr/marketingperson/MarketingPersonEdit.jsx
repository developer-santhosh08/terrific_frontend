...
const MarketingPersonEdit = () => {
    ...
    const handleConfirmUpdate = () => {
        navigate('/power-master/hr/marketing-person');
    };
    ...
    const productOptions = [
        { value: 'pipe_line', label: 'Pipe Line' },
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Edit Marketing Person</h3>
                        <button
                            className="btn-header-back"
                            onClick={() => navigate('/power-master/hr/marketing-person')}
                        >
                            Back
                        </button>
                    </div>
...
export default MarketingPersonEdit;
