            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Create Email Template</h3>
                            ...
                            <div className="row mb-4">
                                <div className="col-12 col-md-3 form-group mb-3">
                                    ...
                                    <input
                                        ...
                                        value={templateName}
                                        onChange={(e) => { setTemplateName(e.target.value); if (errors.templateName) setErrors(p => ({ ...p, templateName: '' })); }}
                                        style={errors.templateName ? { borderColor: '#dc3545', boxShadow: '0 0 0 0.2rem rgba(220,53,69,.25)' } : {}}
                                    />
                                    {errors.templateName && <span className="text-danger" style={{ fontSize: '0.8rem' }}>The template name field is required.</span>}
                                </div>
                            </div>
