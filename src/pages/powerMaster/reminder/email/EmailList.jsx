...
const EmailList = () => {
    ...
    const data = [
        { id: 1, emailDescription: 'Welcome Email', status: 'Active' },
        { id: 2, emailDescription: 'Monthly Newsletter', status: 'Active' }
    ];
                    ...
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center tw-gap-4">
                            <button
                                ...
                                onClick={() => navigate('/power-master/reminder/email/add')}
                            >
                        ...
                        <div className="table-responsive">
                            <table className="table table-bordered table-striped no-margin">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th onClick={() => handleSort('emailDescription')} className="tw-cursor-pointer tw-select-none">Email Description <TableSortIcon direction={sortConfig.key === 'emailDescription' ? sortConfig.direction : null} /></th>
                                ...
                                <tbody>
                                    {sortedData.map((e, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="align-middle">{e.emailDescription}</td>
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/reminder/email/edit/${e.id}`)}>
