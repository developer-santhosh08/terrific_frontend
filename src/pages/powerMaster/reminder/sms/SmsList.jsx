...
const SmsList = () => {
    ...
    const data = [
        { id: 1, smsDescription: 'Welcome SMS', template: 'Welcome to our service...', status: 'Active' },
        { id: 2, smsDescription: 'Reminder SMS', template: 'Your appointment is...', status: 'Active' }
    ];
                    ...
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center tw-gap-4">
                            <button
                                ...
                                onClick={() => navigate('/power-master/reminder/sms/add')}
                            >
                        ...
                        <div className="table-responsive">
                            <table className="table table-bordered table-striped no-margin">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th onClick={() => handleSort('smsDescription')} className="tw-cursor-pointer tw-select-none">Sms Description <TableSortIcon direction={sortConfig.key === 'smsDescription' ? sortConfig.direction : null} /></th>
                                        <th onClick={() => handleSort('template')} className="tw-cursor-pointer tw-select-none">Template <TableSortIcon direction={sortConfig.key === 'template' ? sortConfig.direction : null} /></th>
                                ...
                                <tbody>
                                    {sortedData.map((e, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="align-middle">{e.smsDescription}</td>
                                            <td className="align-middle">{e.template}</td>
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/reminder/sms/edit/${e.id}`)}>
