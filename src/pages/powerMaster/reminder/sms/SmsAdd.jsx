            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Add SMS</h3>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                <div className="col-12 col-md-3 form-group mb-3">
                                    ...
                                    <input type="text" className="form-control" placeholder="SMS Description" />
                                </div>
                                <div className="col-12 col-md-3 form-group mb-3">
                                    <label>Template <span className="text-danger">*</span></label>
                                    <textarea className="form-control" rows="1" placeholder="Template"></textarea>
                                </div>
                                <div className="col-12 col-md-3 form-group mb-3">
                                    <label>Status</label>
                                    <Select 
