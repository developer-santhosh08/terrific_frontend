    ...
    const data = [
        {
            id: 1,
            date: '2026-06-01',
            message: 'Welcome to our platform! Get started today.',
            mobile: '9944680677',
            status: 'Active'
        },
        {
            id: 2,
            date: '2026-06-15',
            message: "Don't miss our upcoming summer sale — great deals await!",
            mobile: '9876543210',
            status: 'Active'
        }
    ];
                    ...
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center tw-gap-4">
                            <button
                                ...
                                onClick={() => navigate('/power-master/bulksms/bulksms/add')}
                            >
...
<button type="button" className="list-action-btn btn-edit" onClick={() => navigate(`/power-master/bulksms/bulksms/edit/${e.id}`)}>
