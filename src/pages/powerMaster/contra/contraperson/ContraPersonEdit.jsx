...
const ContraPersonEdit = () => {
    ...
    useEffect(() => {
        const fetchRecord = async () => {
            ...
            setFetchError('');
            try {
                const result = await apiFetch(`/master/contra-master/${id}`);
                if (!result) return;
                ...
                if (json.status) {
                    ...
                    setFetchError(json.message || 'Failed to fetch record.');
                }
            } catch (err) {
    ...
    // Derive selected state's ID from loaded options + formData.state
    const currentStateId = stateOptions.find(o => o.value === formData.state)?.id ?? null;

    // Fetch cities whenever currentStateId changes (covers both initial load & user change)
    useEffect(() => {
    ...
    const handleConfirmUpdate = async () => {
        ...
        try {
            ...
            if (json.status) {
                ...
                setApiError(json.message || 'Failed to update contra person.');
            }
        } catch (err) {
        ...
        return (
            <section className="content">
                <div className="container-fluid">
                    <div className="card">
                        <div className="card-body tw-text-center tw-py-10 tw-text-slate-500">
                            Loading...
                        </div>
                    </div>
                </div>
                ...
                <div className="container-fluid">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <button className="btn-cancel" onClick={() => navigate('/power-master/contra/contra-person')}>
                                Back to List
                            </button>
                        </div>
                    </div>
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Edit Contra Person</h3>
...
export default ContraPersonEdit;
