    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            ...
            if (data?.status) {
                ...
                setApiError(data?.message || 'Failed to create warranty note.');
            }
        } catch {
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Add Warranty Notes</h3>
...
export default WarrantyNotesAdd;
