    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/master/fright-notes/${itemId}`, {
                    headers: {
                ...
                if (data?.status && data?.data) {
                    ...
                    setFetchError(data?.message || 'Failed to fetch fright note.');
                }
            } catch (error) {
                console.error("Error fetching fright note details:", error);
    ...
    const handleConfirmUpdate = async () => {
        ...
        try {
            ...
            if (data?.status) {
                ...
                setApiError(data?.message || 'Failed to update fright note.');
            }
        } catch {
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Edit Fright Notes</h3>
...
export default FrightNotesEdit;