    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/master/payment-note/${itemId}`, {
                    headers: {
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Edit Payment Notes</h3>
...
export default PaymentNotesEdit;