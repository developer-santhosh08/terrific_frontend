...
const PaymentNotesAdd = () => {
    ...
    const handleConfirmSubmit = async () => {
        try {
            ...
            if (data?.status) {
                navigate('/power-master/payment-notes');
            } else {
                console.error("Failed to add payment note:", data?.message);
                navigate('/power-master/payment-notes');
            }
        } catch (error) {
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Add Payment Notes</h3>
                        <button className="btn-header-back" onClick={() => navigate('/power-master/payment-notes')}>
                            Back
                        </button>
                    </div>
                    <div className="card-body">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-actions mt-3 d-flex justify-content-between gap-2 flex-wrap">
                                <button type="button" className="btn-cancel" onClick={() => navigate('/power-master/payment-notes')}>Cancel</button>
...
export default PaymentNotesAdd;