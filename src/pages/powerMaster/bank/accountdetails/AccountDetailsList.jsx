                                ...
                                <MobileCard key={index}>
                                    ...
                                    <MobileCard.Body>
                                        <div className="tw-grid tw-grid-cols-2 tw-gap-3">
                                            ...
                                            <MobileCard.Field label="Account Number" value={e.accountNumber} />
                                            <MobileCard.Field label="Account Holder Name" value={e.accountHolderName} />
                                            <MobileCard.Field label="Branch" value={e.branch} />
