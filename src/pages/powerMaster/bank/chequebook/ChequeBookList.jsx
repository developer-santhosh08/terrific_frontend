...
const ChequeBookList = () => {
    ...
    const hasActionPermission = hasPermission('Power Master.Bank - Cheque Book.Edit') || hasPermission('Power Master.Bank - Cheque Book.Delete');
                ...
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center tw-gap-4">
                            {hasPermission('Power Master.Bank - Cheque Book.Add') && (
                                <button
                                ...
                                <MobileCard key={index}>
                                    ...
                                    <MobileCard.Body>
                                        <div className="tw-grid tw-grid-cols-2 tw-gap-3">
                                            <MobileCard.Field label="Bank Name" value={e.bank} />
                                            <MobileCard.Field label="Account Name" value={e.account} />
                                            <MobileCard.Field label="No Of Leaf" value={e.noOfLeaf} />
                                            <MobileCard.Field label="Leaf Start Number" value={e.leafStartNumber} />
                                            <MobileCard.Field label="Leaf End Number" value={e.leafEndNumber} />
