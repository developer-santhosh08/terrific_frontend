    ...
    const handleConfirmSubmit = async () => {
        try {
            const payload = {
                ...
                status: status?.value === 'Active' ? 1 : (status?.value === 'Inactive' ? 0 : 1)
            };
            ...
            console.error("Error creating accounts category", error);
            setShowSubmitPopup(false);
        }
    };
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Add Accounts Category</h3>
                            ...
                            <div className="row">
                                <div className="col-12 col-md-3 form-group mb-3">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => { setAccountsCategory(e.target.value); if (errors.accountsCategory) setErrors(p => ({ ...p, accountsCategory: '' })); }}
                                        style={errors.accountsCategory ? { borderColor: '#dc3545', boxShadow: '0 0 0 0.2rem rgba(220,53,69,.25)' } : {}}
                                    />
                                    {errors.accountsCategory && <span className="text-danger" style={{ fontSize: '0.8rem' }}>The accounts category field is required.</span>}
                                </div>
                                <div className="col-12 col-md-3 form-group mb-3">
                                    <label>Status</label>
                                    <Select
...
export default AccountsCategoryAdd;
