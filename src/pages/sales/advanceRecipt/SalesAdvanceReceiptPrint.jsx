        ...
        <Document title={header?.customer_name ? `Receipt-${receipt_number}-${header.customer_name}` : 'Receipt'}>
            <Page size="A4" style={styles.page}>
                ...
                <View style={[styles.container, { padding: 0 }]}>
                    <Text style={styles.title}>ADVANCED RECEIPT</Text>
...
const SalesAdvanceReceiptPrint = () => {
    const { id } = useParams();
    ...
    // Determine type
    const type = 'advance';
    const apiEndpoint = `${import.meta.env.VITE_API_BASE_URL}/api/sales/advance-payments/receipt-single-print/${id}`;
...
export default SalesAdvanceReceiptPrint;
