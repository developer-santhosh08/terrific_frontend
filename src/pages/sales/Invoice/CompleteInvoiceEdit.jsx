...
const CompleteInvoiceEdit = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (data.status) {
                navigate('/sales/invoice', { state: { activeTab: 'completedInvoiceList' } });
            } else {
                ...
                if (json.status && json.data) {
                    ...
                    if (customer_profile) {
                        setFormData(prev => ({
                            ...
                            invoiceNumber: invoice_header ? invoice_header.invoice_number : '',
    ...
    const productDeps = JSON.stringify({
        ...
        cashDiscount: formData.cashDiscount
    });
            ...
            <div className="container-fluid">
                <div className="card tw-mb-0">
                    <div className="card-header with-border tw-flex tw-flex-col sm:tw-flex-row tw-justify-between tw-items-center tw-gap-3 sm:tw-gap-0">
                        ...
                        <button className="btn-header-back" onClick={() => navigate('/sales/invoice', { state: { activeTab: 'completedInvoiceList' } })}>Back</button>
                    </div>
                ...
                <div className="card tw-mt-4">
                    <div className="card-body">
                        ...
                        <div className="form-actions mt-3 d-flex justify-content-between gap-2 flex-wrap">
                            <div>
                                <button type="button" className="btn-cancel" onClick={() => navigate('/sales/invoice', { state: { activeTab: 'completedInvoiceList' } })}>Cancel</button>
                            </div>
                            <div>
                                <button type="button" className="btn-save" onClick={() => setIsSubmitPopupOpen(true)}>Update</button>
                            </div>
                        </div>
                    </div>
                </div>
                <UpdatePopup isOpen={isSubmitPopupOpen} onClose={() => setIsSubmitPopupOpen(false)} onConfirm={handleSubmit} />
            </div>
        </section>
    );
};

export default CompleteInvoiceEdit;
