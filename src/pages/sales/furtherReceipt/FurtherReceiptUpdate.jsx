...
const FurtherReceiptUpdate = () => {
    ...
    useEffect(() => {
        ...
        const fetchReceiptData = async () => {
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/sales/receipts/edit/${id}`, { headers });
                const result = await response.json();
                ...
                if (result.status && result.data) {
                    ...
                    setReceiptData({
                        ...
                        total_invoice_amount: data.total_invoice_amount || '0.00',
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/sales/receipts/update/${id}`, {
                method: 'PUT',
                headers: {
                    'Accept': 'application/json',
    ...
    const confirmCancelReceipt = async () => {
        ...
        try {
            const token = sessionStorage.getItem('token');
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/sales/receipts/cancel/${id}`, {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
            ...
            <section className="content">
                ...
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title tw-text-center sm:tw-text-left tw-w-full sm:tw-w-auto max-[320px]:tw-text-sm max-[320px]:tw-whitespace-nowrap max-[320px]:tw-overflow-hidden max-[320px]:tw-text-ellipsis">Update Receipt</h3>
                    ...
                    <div className="card-body">
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3 form-group">
                                    <label>Invoice Paid Amount (Total)</label>
                            ...
                            <div className="form-actions mt-3 d-flex justify-content-between">
                                <div className="d-flex gap-2">
                                    <button type="button" className="btn-cancel" onClick={() => navigate('/sales/further-receipt')}>Back</button>
...
export default FurtherReceiptUpdate;
