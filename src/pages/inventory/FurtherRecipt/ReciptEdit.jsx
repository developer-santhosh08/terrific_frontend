...
const ReciptEdit = () => {
    ...
    useEffect(() => {
        ...
        const fetchBanks = async () => {
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/inventory/further-payments/banks`, { headers });
                const result = await response.json();
        ...
        const fetchReceiptData = async () => {
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/inventory/further-payments/receipt-create-data/${id}`, { headers });
                const result = await response.json();
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            const token = sessionStorage.getItem('token');
            const payload = {
                customer_id: receiptData?.vendor_id || 26,
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/inventory/further-payments/receipts/${id}`, {
                method: 'PUT',
                headers: {
                    'Accept': 'application/json',
            ...
            <section className="content">
                ...
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title">Create Receipt</h3>
                    ...
                    <div className="card-body">
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <div className="form-actions mt-3 d-flex justify-content-between">
                                <button type="button" className="btn-cancel" onClick={() => navigate('/inventory/further-receipt')}>Cancel</button>
