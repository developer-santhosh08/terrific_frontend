...
const PaymentVoucherReport = () => {
    ...
    const exportColumns = [
        ...
        { header: 'Payee Name', key: 'payeeName' },
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex flex-column flex-md-row justify-content-md-between align-items-start align-items-md-center tw-gap-2 tw-mb-4 tw-text-sm tw-text-slate-600">
                            <div className="d-flex flex-wrap align-items-center tw-gap-4">
                                ...
                                <ExportButtons 
                                    ...
                                    filename="Payment_Voucher_Report"
                                    title="Payment Voucher Report"
                                    tableId="payment-voucher-report-table"
                                />
                            </div>
                            <div className="d-flex align-items-center tw-gap-2">
                                <span>Search:</span>
                        ...
                        <div className="table-responsive tw-hidden md:tw-block">
                            <table id="payment-voucher-report-table" className="table table-bordered table-striped no-margin">
                                <thead>
                                    <tr>
