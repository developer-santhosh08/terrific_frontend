            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border tw-flex tw-flex-col sm:tw-flex-row tw-justify-between sm:tw-items-center tw-gap-3">
                        <h3 className="card-title max-[350px]:tw-text-center max-[350px]:tw-whitespace-nowrap max-[350px]:tw-text-lg">Add Sales Contact</h3>
                                ...
                                <div className="col-md-3 form-group" style={{ position: 'relative' }}>
                                    ...
                                    <CreatableSelect
                                        ...
                                        formatCreateLabel={(inputValue) => (
                                            <div className="btn btn-sm btn-primary tw-w-full tw-text-left tw-py-2 tw-font-semibold tw-flex tw-items-center">
