...
const ClosedContactList = () => {
    const { hasPermission } = usePermissions();
    const hasActionPermission = hasPermission('Sales Contact.Closed Contacts.Delete');
    ...
    useEffect(() => {
        const fetchClosedContacts = async () => {
            ...
            try {
                ...
                const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/salescontact/sales-contact/closed`, { headers });
                ...
                setContacts(data.map(item => {
                    ...
                    return {
                        id: item.id,
                        sno: `C-${item.id.toString().padStart(2, '0')}`,
                        ...
                        currentStage: String(item.contact_status) === '2' ? 'Order Lost' : 'Order Lost'
                    };
                }));
            } catch (err) {
    ...
    return (
        <section className="content">
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title max-[350px]:tw-text-center max-[350px]:tw-whitespace-nowrap max-[350px]:tw-text-lg">Order Lost Contact Details</h3>
                    </div>
                                                    ...
                                                    <td>
                                                        <div className="tw-flex tw-gap-2">
                                                            ...
                                                            <button 
                                                                ...
                                                                title="Edit"
                                                                onClick={() => navigate(`/sales-contact/edit/${contact.id}`)}
                                                            >
                                                                <PencilSimpleIcon weight="duotone" className="tw-w-4 " />
                                                            </button>
                                                            */}
                                                            {hasPermission('Sales Contact.Closed Contacts.Delete') && (
                                                                <button 
                                                                    type="button" 
            ...
            <DeletePopup 
                ...
                message="Are you sure you want to delete this closed contact?"
            />
        </section>
    );
};

export default ClosedContactList;
