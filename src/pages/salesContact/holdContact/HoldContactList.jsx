...
const HoldContactList = () => {
    const { hasPermission } = usePermissions();
    const hasActionPermission = hasPermission('Sales Contact.Hold Contacts.Delete');
    ...
    useEffect(() => {
        const fetchholdContacts = async () => {
            ...
            try {
                ...
                // Fetch the newly added hold sales contact API
                const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/salescontact/sales-contact/hold`, { headers });
                ...
                setContacts(data.map(item => {
                    ...
                    return {
                        ...
                        currentStage: String(item.contact_status) === '4' ? 'Hold' : 'Hold'
                    };
                }));
            } catch (err) {
                console.error("Error fetching hold sales contacts:", err);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <section className="content">
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header with-border d-flex justify-content-between align-items-center">
                        <h3 className="card-title max-[350px]:tw-text-center max-[350px]:tw-whitespace-nowrap max-[350px]:tw-text-lg">Hold Contact Details</h3>
                    </div>
                                                ...
                                                {hasActionPermission && (
                                                    <td>
                                                        <div className="tw-flex tw-gap-2">
                                                            ...
                                                            */}
                                                            {hasPermission('Sales Contact.Hold Contacts.Delete') && (
                                                                <button
                                                                    type="button"
            ...
            <DeletePopup
                ...
                message="Are you sure you want to delete this Hold Contact?"
            />
        </section>
    );
};

export default HoldContactList;
