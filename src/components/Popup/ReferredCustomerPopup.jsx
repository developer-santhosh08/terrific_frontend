...
const ReferredCustomerPopup = ({ isOpen, onClose, onSubmit, initialName = '' }) => {
    ...
    const confirmSubmit = async () => {
        ...
        try {
            ...
            if (json.status === 'success' || json.status === true) {
                // Success
                if (onSubmit) onSubmit(json.data); // Pass the newly created customer to parent
                onClose();
            } else {
        ...
        <div className="tw-fixed tw-inset-0 tw-flex tw-items-center tw-justify-center tw-bg-slate-900/40 tw-p-4 sm:tw-p-6" style={{ zIndex: 999999 }}>
            ...
            <div className="tw-bg-white tw-w-full tw-max-w-4xl tw-max-h-full tw-flex tw-flex-col tw-rounded-xl tw-shadow-2xl tw-overflow-hidden tw-relative tw-z-[1060] tw-border-2 tw-border-blue-600/20">
                ...
                <div className="tw-flex tw-items-center tw-justify-between tw-p-4 sm:tw-p-5 tw-border-b tw-border-gray-100 tw-shrink-0 tw-bg-gray-50/50">
                    <h5 className="tw-text-lg sm:tw-text-xl tw-font-bold tw-text-gray-800 tw-m-0">Referred Customer</h5>
                    <button 
                        type="button" 
                        onClick={onClose} 
                    ...
                    <div className="row tw-m-0">
                        <div className="col-md-6 tw-px-2">
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input type="text" className="form-control tw-text-sm" value={name} onChange={e => setName(e.target.value)} placeholder="Name" />
                            </div>
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input type="text" className="form-control tw-text-sm" value={mobile} onChange={e => setMobile(e.target.value)} placeholder="Mobile Number 1" />
                            </div>

                            <div className="form-group mb-3">
                                <label className="tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1 tw-block">Customer GSTIN</label>
                                <input type="text" className="form-control tw-text-sm" value={gstin} onChange={e => setGstin(e.target.value)} placeholder="GSTIN" />
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 tw-px-2">
                            <div className="form-group mb-3">
                                ...
                                <input type="text" className="form-control tw-text-sm" value={addr1} onChange={e => setAddr1(e.target.value)} placeholder="Address Line 1" />
                            </div>
                            <div className="form-group mb-3">
                                <label className="tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1 tw-block">Address Line 2</label>
                                <input type="text" className="form-control tw-text-sm" value={addr2} onChange={e => setAddr2(e.target.value)} placeholder="Address Line 2" />
                            </div>
                            <div className="form-group mb-3">
                                <label className="tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1 tw-block">Address Line 3</label>
                                <input type="text" className="form-control tw-text-sm" value={addr3} onChange={e => setAddr3(e.target.value)} placeholder="Address Line 3" />
                            </div>
                            <div className="form-group mb-3">
                                <label className="tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1 tw-block">Pincode</label>
                                <input type="text" className="form-control tw-text-sm" value={pincode} onChange={e => setPincode(e.target.value)} placeholder="Pincode" />
                            </div>
                            <div className="form-group mb-3">
...
export default ReferredCustomerPopup;
