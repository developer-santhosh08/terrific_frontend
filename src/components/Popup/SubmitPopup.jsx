const SubmitPopup = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {/* Card */}
            <div className="confirm-popup-box" style={{ position: 'relative', background: '#fff', borderRadius: 16, width: 380, padding: '36px 32px 28px', boxShadow: '0 25px 60px rgba(0,0,0,0.22)', textAlign: 'center', border: '1.5px solid #bbf7d0' }}>
                ...
                <p style={{ color: '#64748b', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: 28 }}>
                    Are you sure you want to <strong style={{ color: '#16a34a' }}>submit</strong> this data?<br />
                    This action will save the record.
                </p>
